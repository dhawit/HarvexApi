...
router.post('/', asyncHandler(async (req, res) => {
    ...
    if (couponCode === undefined || couponCode === null || discountType === undefined || discountType === null|| discountAmount === undefined || discountAmount ===null || endDate === undefined || endDate === null || status === undefined || status === null) {
